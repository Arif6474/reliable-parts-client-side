...
const Support = () => {
    return (
        <div className="my-32 text-white flex flex-col lg:flex-row justify-center gap-40 lg:gap-96 items-center">
        <div className=" space-y-8 ">
          <h1 data-aos="flip-up"
          data-aos-easing="linear"
          data-aos-duration="1500" className="font-bold text-4xl text-start">want support?</h1>
          ...
          data-aos-duration="1200" className="flex gap-4 justify-start items-center">
            <svg
              ...
              stroke-width="1.5"
              stroke="currentColor"
              class="w-12 h-12 p-2 rounded-full text-green-300"
            >
              <path
            ...
            <div>
              <p className=" font-medium mr-2">+49 176 123 456</p>
          ...
          data-aos-duration="1500" className="flex gap-4 justify-start items-center">
            <svg
              ...
              stroke-width="1.5"
              stroke="currentColor"
              class="w-12 h-12 p-2 rounded-full text-orange-400"
            >
              <path
                stroke-linecap="round"
                stroke-linejoin="round"
            ...
            <div>
              <p className=" font-medium text-sm">support@reliable.com</p>
              <p className=" font-medium opacity-80 text-xs">Support Email</p>
            </div>
          </div>
        ...
        <div className=" space-y-3 ">
          ...
          data-aos-duration="800" class="border-b-2 border-slate-200 w-[320px] duration-100 space-y-4 mx-auto">
            ...
            How do I purchase good products?
            </summary>
            <div class=" px-5 py-3 w-[320px] border  border-gray-100 text-sm font-light">
          ...
          data-aos-duration="1000" class="border-b-2 border-slate-200 w-[320px] duration-100 space-y-4 mx-auto">
            <summary class="font-medium text-start pl-2 py-1 text-lg cursor-pointer">
            How can I know about new parts?
            </summary>
            <div class=" px-5 py-3 w-[320px] border  border-gray-100 text-sm font-light">
              <p className="font-medium opacity-80 text-start pl-2 ">
                Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
          ...
          data-aos-duration="1200" class="border-b-2 border-slate-200 w-[320px] duration-100 space-y-4 mx-auto">
            <summary class="font-medium text-start pl-2 py-1 text-lg cursor-pointer">
            How to change my account profile?
            </summary>
            <div class=" px-5 py-3 w-[320px] border  border-gray-100 text-sm font-light">
              <p className="font-medium opacity-80 text-start pl-2">
                Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
