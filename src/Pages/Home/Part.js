...
// </div>
<div>
<div className="rounded-xl bg-[#0c1839] mx-auto my-4 lg:w-96  shadow-lg hover:shadow-blue-800 transition duration-700 ease-in-out  hover:-translate-y-1 hover:scale-110">
  <div className="flex justify-between lg:items-start gap-4  flex-col lg:flex-row">
    ...
    <div className="p-4 lg:p-0">
     <div className="flex flex-row lg:flex-col lg:justify-start justify-between   lg:gap-0">
      ...
      <button onClick={() => navigateToPartDetails(_id)} className="btn bg-[#0f676c] hover:bg-[#119096] btn-sm border-none text-white font-semibold lg:mt-2">Purchase</button>
    </div>
  </div>
</div>
</div>
