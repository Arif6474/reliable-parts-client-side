      ...
      <div className="flex justify-between  gap-4  flex-col">
        ...
        <div className=" p-4 lg:pl-4 ">
          <div className="flex flex-row lg:flex-col lg:justify-center justify-between   lg:gap-0">
            <h1 className="text-lg font-medium  text-white opacity-90">{name}</h1>
       ...
       <div className="ml-4 lg:mx-auto w-20">
       <button
          onClick={() => navigateToPartDetails(_id)}
          className="btn hover:bg-[#257b13] bg-[#41a317]  btn-xs border-none text-white font-semibold mb-3"
        >
          Purchase
        </button>
       </div>
