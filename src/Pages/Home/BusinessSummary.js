...
const BusinessSummary = () => {
  return (
    <div> 
      ...
      <Serve image={currency} back="bg-teal-600 " serveTitle="Annual revenue" details="$80m+" ></Serve>
        <Serve image ={parts} back="bg-indigo-600" serveTitle="Parts, We have" details="150+" ></Serve>
      </div>
    </div>
  );
};
