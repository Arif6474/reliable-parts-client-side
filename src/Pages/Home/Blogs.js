...
const Blogs = () => {
  ...
  <div className="card-body">
    ...
    data-aos-duration="1500" className="text-xl text-white">How will you improve the performance of a React Application?</h2>
  ...
  <div className="card-body">
    <h2 data-aos="flip-up" 
    data-aos-easing="linear"
    data-aos-duration="1500" className="text-xl text-white">What are the different ways to manage a state in a React application?</h2>
  ...
  <div className="card-body">
    <h2 data-aos="flip-up" 
    data-aos-easing="linear"
    data-aos-duration="1500" className="text-xl text-white"> How does prototypical inheritance work?</h2>
  ...
  <div className="card-body">
    <h2 data-aos="flip-up" 
    data-aos-easing="linear"
    data-aos-duration="1500" className="text-xl text-white">What is a unit test?</h2>
    ...
    <h2 data-aos="flip-up" 
    data-aos-easing="linear"
    data-aos-duration="1500" className="text-xl text-white">Why should write unit tests?</h2>
